...
@section('add-package')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mb-3">Add Destination</h4>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="custom-styles-preview">
                            <form class="needs-validation" id="destinationForm" method="POST" action="{{ route('destination.store') }}" enctype="multipart/form-data"  novalidate>
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" value="{{ old('short_description') }}"  name="short_description"  rows="5" id="example-textarea" required></textarea>
                                        </div>
                                        <div class="mb-3 ">
