            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="custom-styles-preview">
                        <form class="needs-validation" method="POST" action="{{ route('gallery.store') }}" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6 mb-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select mb-3" name="media_type" {{ old('media_type') }}id="media_type" required>
