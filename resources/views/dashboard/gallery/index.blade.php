                        ...
                        <table class="table table-centered table-borderless table-hover w-100 dt-responsive nowrap" id="products-datatable">
                            ...
                            <tbody>
                                @foreach ($gallery as $item)
                                    <tr>
                                        <td class="table-user">
                                            @if ($item->media_type == 'VIDEO')
                                                <img src="{{ asset('dashboard/assets/images/gallery/video.jpg') }}" class="me-2 rounded-circle" style="width: 40px; height: 40px; object-fit: cover;" alt="Video Placeholder">
                                            ...
                                            @elseif ($item->media_type == 'YOUTUBE' )
                                                <img src="{{ asset('dashboard/assets/images/gallery/youtube.jpeg') }}" class="me-2 rounded-circle"  style="width: 40px; height: 40px; object-fit: cover;" alt="Video Placeholder">
                                            @else
                                        ...
                                        <td>
                                            @if($item->title)
                                                {{ $item->title }}
                                            @else
                                                <span class="small text-danger">No title available</span>
                                            @endif
                                        </td>
                                        <td>
                                            @if($item->subtitle)
                                                {{ $item->subtitle }}
                                            @else
                                                <span class="small text-danger">No subtitle available</span>
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="action-icon" data-bs-toggle="modal" data-bs-target="#bs-editGallery-modal{{ $item->id}}">
                                    ...
                                    <!-- Edit Modal -->
                                    <div class="modal fade" id="bs-editGallery-modal{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="editGalleryLabel{{$item->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="editGalleryLabel{{ $item->id }}">Edit Gallery</h4>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-control" name="media_type" id="media_type{{ $item->id }}" onchange="toggleMediaFields({{ $item->id }})" disabled>
                                                                ...
                                                                <div class=" media-youtube{{ $item->id }}" style="display: {{ $item->media_type == 'YOUTUBE' ? 'block' : 'none' }};">
                                                                ...
                                                                <div class="media-video{{ $item->id }}" style="display: {{ $item->media_type == 'VIDEO' ? 'block' : 'none' }};">
                                                                    @if($item->video)
                                                                        <figure class="portfolio-item gallery-caption" style="">
                                                                ...
                                                                <div class="media-image{{ $item->id }}" style="display: {{ $item->media_type == 'IMAGE' ? 'block' : 'none' }};">
                                                                    <div class="mb-3">
